...
if (!class_exists(Handler::class))
{
    abstract class Handler
    {
        ...
        private \Morphine\Renders\ IterableView $iterable;
         ...
         * Conditional Iterable views : Views that are a combination between Iterable and Conditional
         */
        ...
        public function __construct(\Morphine\Renders\ View $requested_view)
        {
            $this->db = $GLOBALS['DB'];
