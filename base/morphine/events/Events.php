...
if( !class_exists(Events::class))
{
    class Events
    {
        ...
        private \Morphine\Events\Dispatcher\Dispatch $dispatcher;
        ...
        function __invoke()
        {
            ...
            $this->dispatcher = new \Morphine\Events\Dispatcher\Dispatch();
        ...
        private function extract_request(&$data)
        {
            ...
            self::$URI = strtr($data['server']['REQUEST_URI'], [$GLOBALS['App.EntryPoint'] => '']);
