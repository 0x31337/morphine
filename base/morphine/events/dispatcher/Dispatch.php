...
namespace Morphine\Events\Dispatcher;


use Morphine\Events\Events;
use Morphine\Events\Route;
    ...
    class Dispatch extends Events
    {
        ...
        public function __invoke()
        {
             ...
             else
            {
                ...
                \Morphine\Events\Display::_render($this->custom_display, parent::$req_data);
            }
        }
        ...
        private function dispatch()
        {
            ...
            {
                \Morphine\Events\Operation::{$this->surface->operation}(parent::$req_data);
            }

            if(isset($this->surface->display))
            {
                $this->check_redirection($this->surface->display);
                \Morphine\Events\Display::_render($this->surface->display, parent::$req_data);
            }
        }
        ...
        {
            // TODO : manage access control somewhere outside the scope for Morphine users
        ...
        private function rules_validation($rule, $input)
        {
            ...
            if(!empty($rule))
            {
                return \Morphine\Engine\Security\Rules::$rule($input);
            }
            else return true;
        }
